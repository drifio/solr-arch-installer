...
if [ $? -ne 0 ]; then
  ...
  if [ "$distro" == "RedHat" ] || [ "$distro" == "CentOS" ] || [ "$distro" == "Arch" ]; then
...
if [ "$distro" == "Arch" ]; then
  # copy systemd file
  cp solr.service "/etc/systemd/system/$SOLR_SERVICE.service"
